...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Optional subfolder under outputs/phase1/runs/<tag>/arrays to avoid overwriting default outputs.",
    )
    ...
    out_dir = (
        ROOT / "outputs" / "phase1" / "runs" / args.run_tag / "arrays"
        if args.run_tag
        else ROOT / "outputs" / "phase1" / "arrays"
    )
